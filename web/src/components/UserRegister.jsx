        ...
        <main className="flex justify-center items-center bg-white h-screen w-full">
            ...
            <section className="bg-white h-screen w-full flex flex-col items-center gap-5 py-10   ">
                <header className="text-center">
                    <h1 className="text-3xl uppercase font-extrabold tracking-tight">Create Account</h1>
                    <p className="text-xl">Welcome to eWallet</p>
                </header>


                <form className="flex flex-col gap-5 w-full max-w-md p-6 ">
                    <div className="flex flex-col gap-1">
                        <label htmlFor='mobileNumber' className="font-semibold">Mobile Number</label>
                        <input type="text" placeholder="Enter your registered mobile number" id='mobileNumber' className="w-full border border-black rounded-md h-12 pl-6"/>
                    </div>

                    <div className="flex flex-col gap-1">
                        <label htmlFor='emailAddress' className="font-semibold">Email Address</label>
                        <input type="email" placeholder="Enter your email address" id='emailAddress' className="w-full border border-black rounded-md h-12 pl-6"/>
                    </div>

                    <div className="flex flex-col gap-1">
                        <label htmlFor='fullName' className="font-semibold" >Full Name</label>
                        <input type="text" placeholder="Enter your full name" id='fullName' className="w-full border border-black rounded-md h-12 pl-6"/>
                    </div>

                     <div className="flex flex-col gap-1">
                        <label htmlFor='password' className="font-semibold">Password</label>
                        <input type="password" placeholder="Enter your password" id='password' className="w-full border border-black rounded-md h-12 pl-6"/>
                    </div>

                    <div className="flex flex-col gap-1">
                        <label htmlFor='password' className="font-semibold">Identification Type</label>
                        <select className="w-full border border-black rounded-md h-12 pl-6">
                    ...
                    <button className="bg-[#043d7d] p-3 w-full  text-white mt-5">Create Account</button>
